...
function isRequirementSatisfied(availableCourses: string[], requirement: Requirement) {
    ...
    switch(requirement.function){
        ...
        case 'AND':
            ...
            availableCourses = availableCourses.filter((v) => !leftResponse[1].includes(v))
            if(requirement.overlapAllowed){
                ...
                availableCourses = leftResponse[1] + availableCourses
            }
...
"CSCI 1951A", "CLPS 0220", "CLPS 0700", "MATH 0520", "MATH 0200", "MATH 0100", "CSCI 2470", "CSCI 1430", "CSCI 1951Z", "HIST 0234", "CSCI 0220"]
